...
# Ensure absolute imports work by adding current dir to sys.path if needed
# (PyInstaller usually handles this, but explicit is better for dev)
...
class DecoSecurityService(win32serviceutil.ServiceFramework):
    ...
    def SvcDoRun(self):
        try:
            ...
            # Ensure working directory is correct (where the exe is)
    ...
    def main(self):
        try:
            ...
            # Import main here to avoid circular dependencies if any, 
            # though top-level import is preferred for 'No module' detection.
            # We already imported main_loop at top.
            main_loop() 
        except Exception as e:
